...
Operational backup and restore instructions for `jur_db` are maintained in `docs/backup_restore.md`. Create and verify a fresh backup before production migrations, n8n workflow changes that alter stored payloads, or large corpus ingestion runs.
